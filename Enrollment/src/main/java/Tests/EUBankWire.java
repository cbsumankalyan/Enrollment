...
public class EUBankWire extends SuperTestNG {
	...
	public void BankWire(String Market, String language, String pack, String Payment) throws InterruptedException, JSONException, IOException, ParseException{
		
		childtest = BankWire.createNode("<b><font color=407899>" + Market + "  |  " + language + "  |  " + Payment + "</font></b>");
